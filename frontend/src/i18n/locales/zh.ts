export default {
  ...
  imageGeneration: {
    title: 'Image2 生图',
    description: '在浏览器中直连外部 Base URL 生成图片',
    baseUrl: 'Base URL',
    baseUrlPlaceholder: 'https://api.example.com',
    baseUrlHint: '会自动拼接 /v1/images/generations；不会保存到服务端。',
    apiKey: 'API Key',
    apiKeyPlaceholder: 'sk-...',
    apiKeyHint: '仅用于本次浏览器请求，刷新页面后不会持久保存。',
    ...
    privacyNote: '请求由当前浏览器直接发送到你填写的 Base URL。本页面不调用本站后端接口，也不持久化 Base URL、API Key 或提示词。',
    generate: '生成图片',
    generating: '生成中...',
    clear: '清空',
    result: '生成结果',
    waiting: '正在等待 image2 返回图片',
    emptyTitle: '还没有生成图片',
    emptyDescription: '填写 Base URL、API Key 和提示词后开始生成。',
    rawResponse: '原始响应',
    download: '下载',
    downloadAll: '下载全部',
    copyImageUrl: '复制图片地址',
    ...
    statusIdle: '等待发起浏览器直连请求',
    statusGenerating: '请求已发送，等待上游响应',
    statusSuccess: '已收到 {count} 张图片',
    auto: '自动',
    low: '低',
    medium: '中',
    high: '高',
