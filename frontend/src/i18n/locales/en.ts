export default {
  ...
  imageGeneration: {
    title: 'Image2 Generation',
    description: 'Generate images by calling an external Base URL from the browser',
    baseUrl: 'Base URL',
    baseUrlPlaceholder: 'https://api.example.com',
    baseUrlHint: 'The page appends /v1/images/generations automatically and does not save it server-side.',
    apiKey: 'API Key',
    apiKeyPlaceholder: 'sk-...',
    apiKeyHint: 'Only used for this browser request and not persisted after refresh.',
    ...
    count: 'Count',
    prompt: 'Prompt',
    promptPlaceholder: 'Describe the scene, subject, style, composition, and details...',
    privacyNote: 'The request is sent directly from this browser to the Base URL you enter. This page does not call this site backend or persist the Base URL, API Key, or prompt.',
    generate: 'Generate Image',
    generating: 'Generating...',
    clear: 'Clear',
    result: 'Result',
    waiting: 'Waiting for image2 to return images',
    emptyTitle: 'No images yet',
    emptyDescription: 'Enter the Base URL, API Key, and prompt to start.',
    rawResponse: 'Raw Response',
    download: 'Download',
    downloadAll: 'Download All',
    copyImageUrl: 'Copy image URL',
    copied: 'Copied',
    rawCopied: 'Response copied',
    success: 'Generated {count} image(s)',
    statusIdle: 'Waiting for a browser-direct request',
    statusGenerating: 'Request sent, waiting for upstream response',
    statusSuccess: 'Received {count} image(s)',
    auto: 'Auto',
    low: 'Low',
    medium: 'Medium',
    high: 'High',
    errors: {
      ...
      noImage: 'No previewable image was found in the response',
  ...
  nav: {
    ...
    imageGeneration: 'Image2 Generation',
